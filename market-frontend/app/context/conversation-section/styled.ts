const rootConversationsClasses = "fixed bottom-0 right-8"
...
const headerConversationContainerClasses = "w-full shrink-0 p-2 flex   items-center overflow-hidden justify-stretch h-12 shadow"

const leftHeaderConversationClasses = "w-9/12 flex items-center"

const rightHeaderConversationClasses = "w-3/12 flex justify-end gap-2 items-center"

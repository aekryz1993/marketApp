...
const portalContainerClasses = clsx("relative w-full md:max-w-[768px] md:shadow-3xl bg-bg-light-sec dark:bg-bg-dark-sec flex flex-col justify-start items-stretch overflow-y-auto")
